<%@ Page Title="" Language="C#" MasterPageFile="~/Client.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="BeerStore.UL.AdminLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:Button ID="HyperLink1" CssClass="btn-link" runat="server" Text="Forgot Password? Click to change" OnClick="change_click" CausesValidation="false"></asp:Button>
    </div>
    <div>
